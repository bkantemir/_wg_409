    ...
    */
        ...
        for (int primitiveN = 0; primitiveN < primitivesN; primitiveN++) {
            ...
            */
            ...
            if (pPrimitive->material < 0) {
                ...
                strcpy_s(pMt->materialName, 32, "default");
                ...
                tinygltf::Material:
                      ...
                      Value extras;
                */
                strcpy_s(pMt->materialName, 32, pMaterial->name.c_str());
    ...
    for (int nodeN = 0; nodeN < nodesN; nodeN++) {
        ...
        */
        ...
        strcpy_s(pAN->name, 64, (char*)nodeName.c_str());
...
int GLTFparser::setSkinnedShader(Material* pMt) {
    if (pMt->shaderN < 0)
        return 0;
    Shader::assignShader(pMt, "skin " + std::string(pMt->shaderType));
    return 1;
}
